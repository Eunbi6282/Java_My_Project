...
// TreeMap <K,V> : Key가 정렬되어서 처리<오름차순 정렬>
	// Key: 일반 객체를 사용할 경우, Comparable<E>인터페이스의 compareTo(), Comparator<E> compare()재정의가 필요. 
...
public class TreeMapMethod_2 {
	...
	public static void main(String[] args) {
		//1. MyClass를 TreeMap의 ㅏKey로 인풋할 경우 : 실행시 오류
//		TreeMap<MyClass, String> treeMap1 = new TreeMap<>();
//		MyClass m1 = new MyClass(2,5);
//		MyClass m2 = new MyClass(3, 3);
//		
//		treeMap1.put(m1, "첫번째");	//Comparable, Comparator구현하지 않았는데 TreeMap의 Key로 사용, 실행시 오류
// 		treeMap1.put(m2, "두번째");  
// 		System.out.println(treeMap1);
		...
		//3. Comparator을 구현 : 기존의 객체를 사용, 객체 수정이 붎ㄹ요하다.
		...
		MyClass my6 = new MyClass(30, 30);
		MyClass my5 = new MyClass(3, 3);
		
		treeMap3.put(my4, "첫번째");
		treeMap3.put(my6, "세번째");
		treeMap3.put(my5, "두번째");
